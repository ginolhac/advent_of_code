...
for (i in seq_len(aim)) {
  if (i %% 5000 == 0) message("treating iteration: ", i, " (", round((i / aim) * 100, 2),"%)")
...
35.514 seconds for 1e5 and example
550.767 seconds for 1e5 and real input
...
tibble(y = current_load,
       dir = rep(c("N", "W", "S", "E"), aim / 4),
       x = seq_len(aim)) |> #count(y, dir, sort = TRUE)
  head(1000) |> 
  ...
  labs(x = "Iteration",
       ...
       colour = "Shifting\ndirection") 
#anim_save("2023/day14_part2_input.gif")

```


105711
116574 too high (true is 98029)

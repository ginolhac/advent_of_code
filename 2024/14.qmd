...
filter(tib_quad2, n > 200) |> arrange(desc(n))
plot_robot(res[[6653]])


write_rds(tib_quad2, "day14_tib_quad2.rds")
```

7956 and 7955 too high
6653 should be good but not right
...
map(res[6650:6660], \(x) map(x, pluck, "pos") |> 
        enframe(value = "pos") |> 
        unnest_wider(pos, names_sep = "_")) |> 
...
ggplot(tib_plot, aes(pos_1, pos_2, group = name)) +
    ...
    transition_states(as.integer(id) + 6650) +
